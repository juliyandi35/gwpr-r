...
Parameter_GWPR[1:34,]
write.table(Parameter_GWPR,file="D:\\SKRIPSI DETA\\DATA SKRIPSI\\Hasil_Parameter_GWPR.csv",sep=",")

#Nilai P-Value Masing-Masing Parameter Tiap Provinsi
PValue_GWPR <- as.data.frame(gwr.t.adjust(hasil.GWPRBISQUR)$results$p)
PValue_GWPR[1:34,]
write.table(PValue_GWPR,file="D:\\SKRIPSI DETA\\DATA SKRIPSI\\Hasil_PValue_GWPR.csv",sep=",")

#Nilai R-Squared Dari Model Tiap Provinsi
RLocal_GWPR <- as.data.frame(hasil.GWPRBISQUR$SDF$Local_R2)
RLocal_GWPR[1:34,]
write.table(RLocal_GWPR,file="D:\\SKRIPSI DETA\\DATA SKRIPSI\\Hasil_Rlocal_GWPR.csv",sep=",")
...
d
write.table(RLocal_GWPR,file="D:\\SKRIPSI DETA\\DATA SKRIPSI\\Hasil_Jarak_Euclidean.csv",sep=",")
